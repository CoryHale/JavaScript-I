...
let idNum = 33;
console.log(`Car ${idNum} is a ${inventory[idNum - 1].car_year} ${inventory[idNum - 1].car_make} ${inventory[idNum - 1].car_model}`);
...
console.log("These are all of the BMW and Audi's in our inventory:" + JSON.stringify(BMWAndAudi));